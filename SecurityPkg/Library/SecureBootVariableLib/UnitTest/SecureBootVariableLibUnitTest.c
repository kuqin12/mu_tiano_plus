...
{
  UINT8       SecureBootMode = 3; // Any random magic number...
  EFI_STATUS  Status;

  expect_value (MockSetVariable, VariableName, EFI_CUSTOM_MODE_NAME);
  ...
  )
{
  ...
  expect_value (MockGetVariable, VariableName, EFI_SETUP_MODE_NAME);
  ...
  )
{
  ...
  expect_value (MockGetVariable, VariableName, EFI_SECURE_BOOT_MODE_NAME);
  expect_value (MockGetVariable, VendorGuid, &gEfiGlobalVariableGuid);
  ...
  )
{
  ...
  expect_value (MockGetVariable, VariableName, EFI_IMAGE_SECURITY_DATABASE);
  ...
  expect_value (MockSetVariable, VariableName, EFI_IMAGE_SECURITY_DATABASE);
  ...
  )
{
  ...
  expect_value (MockGetVariable, VariableName, EFI_IMAGE_SECURITY_DATABASE1);
  expect_value (MockGetVariable, VendorGuid, &gEfiImageSecurityDatabaseGuid);
  expect_value (MockGetVariable, *DataSize, 0);
  ...
  expect_value (MockSetVariable, VariableName, EFI_IMAGE_SECURITY_DATABASE1);
  expect_value (MockSetVariable, VendorGuid, &gEfiImageSecurityDatabaseGuid);
  expect_value (MockSetVariable, Attributes, EFI_VARIABLE_NON_VOLATILE | EFI_VARIABLE_RUNTIME_ACCESS | EFI_VARIABLE_BOOTSERVICE_ACCESS | EFI_VARIABLE_TIME_BASED_AUTHENTICATED_WRITE_ACCESS);
  expect_value (MockSetVariable, DataSize, VAR_AUTH_DESC_SIZE);
  expect_memory (MockSetVariable, Data, Payload, VAR_AUTH_DESC_SIZE);
  ...
  )
{
  ...
  expect_value (MockGetVariable, VariableName, EFI_IMAGE_SECURITY_DATABASE2);
  expect_value (MockGetVariable, VendorGuid, &gEfiImageSecurityDatabaseGuid);
  expect_value (MockGetVariable, *DataSize, 0);
  ...
  expect_value (MockSetVariable, VariableName, EFI_IMAGE_SECURITY_DATABASE2);
  expect_value (MockSetVariable, VendorGuid, &gEfiImageSecurityDatabaseGuid);
  expect_value (MockSetVariable, Attributes, EFI_VARIABLE_NON_VOLATILE | EFI_VARIABLE_RUNTIME_ACCESS | EFI_VARIABLE_BOOTSERVICE_ACCESS | EFI_VARIABLE_TIME_BASED_AUTHENTICATED_WRITE_ACCESS);
  expect_value (MockSetVariable, DataSize, VAR_AUTH_DESC_SIZE);
  expect_memory (MockSetVariable, Data, Payload, VAR_AUTH_DESC_SIZE);
  ...
  )
{
  ...
  expect_value (MockGetVariable, VariableName, EFI_KEY_EXCHANGE_KEY_NAME);
  expect_value (MockGetVariable, VendorGuid, &gEfiGlobalVariableGuid);
  expect_value (MockGetVariable, *DataSize, 0);
  ...
  expect_value (MockSetVariable, VariableName, EFI_KEY_EXCHANGE_KEY_NAME);
  ...
  )
{
  ...
  expect_value (MockGetVariable, VariableName, EFI_PLATFORM_KEY_NAME);
  expect_value (MockGetVariable, VendorGuid, &gEfiGlobalVariableGuid);
  expect_value (MockGetVariable, *DataSize, 0);
  ...
  expect_value (MockSetVariable, VariableName, EFI_PLATFORM_KEY_NAME);
  expect_value (MockSetVariable, VendorGuid, &gEfiGlobalVariableGuid);
  expect_value (MockSetVariable, Attributes, EFI_VARIABLE_NON_VOLATILE | EFI_VARIABLE_RUNTIME_ACCESS | EFI_VARIABLE_BOOTSERVICE_ACCESS | EFI_VARIABLE_TIME_BASED_AUTHENTICATED_WRITE_ACCESS);
  expect_value (MockSetVariable, DataSize, VAR_AUTH_DESC_SIZE);
  expect_memory (MockSetVariable, Data, Payload, VAR_AUTH_DESC_SIZE);
  ...
  )
{
  ...
  Status = SetSecureBootVariables (&PayloadInfo);
  UT_ASSERT_NOT_EFI_ERROR (Status);
  ...
  )
{
  ...
  AddTestCase (SecureBootVarEnrollTests, "SetSecureBootVariables should complete", "SetSecureBootVariables Normal", SetSecureBootVariablesShouldComplete, NULL, NULL, NULL);
  AddTestCase (SecureBootVarEnrollTests, "SetSecureBootVariables should stop when already enabled", "SetSecureBootVariables Already Started", SetSecureBootVariablesShouldStopWhenSecure, NULL, NULL, NULL);
  AddTestCase (SecureBootVarEnrollTests, "SetSecureBootVariables should stop when DB failed", "SetSecureBootVariables Fails DB", SetSecureBootVariablesShouldStopFailDB, NULL, NULL, NULL);
  AddTestCase (SecureBootVarEnrollTests, "SetSecureBootVariables should stop when DBT failed", "SetSecureBootVariables Fails DBT", SetSecureBootVariablesShouldStopFailDBT, NULL, NULL, NULL);
  AddTestCase (SecureBootVarEnrollTests, "SetSecureBootVariables should stop when DBX failed", "SetSecureBootVariables Fails DBX", SetSecureBootVariablesShouldStopFailDBX, NULL, NULL, NULL);
  AddTestCase (SecureBootVarEnrollTests, "SetSecureBootVariables should stop when KEK failed", "SetSecureBootVariables Fails KEK", SetSecureBootVariablesShouldStopFailKEK, NULL, NULL, NULL);
  AddTestCase (SecureBootVarEnrollTests, "SetSecureBootVariables should stop when PK failed", "SetSecureBootVariables Fails PK", SetSecureBootVariablesShouldStopFailPK, NULL, NULL, NULL);
  AddTestCase (SecureBootVarEnrollTests, "SetSecureBootVariables should only be optional", "SetSecureBootVariables DBT Optional", SetSecureBootVariablesDBTOptional, NULL, NULL, NULL);
